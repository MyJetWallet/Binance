...
namespace Binance.Tests.Client
{
    public class AggregateTradeClientTests
    {
        ...
        public void Subscribe()
        {
            ...
            ClassicAssert.Equal(AggregateTradeClient.GetStreamName(symbol1), _client.SubscribedStreams.Single());
            ...
            ClassicAssert.Contains(AggregateTradeClient.GetStreamName(symbol1), _client.SubscribedStreams);
            ClassicAssert.Contains(AggregateTradeClient.GetStreamName(symbol2), _client.SubscribedStreams);
        }
