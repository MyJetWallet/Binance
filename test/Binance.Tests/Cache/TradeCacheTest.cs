...
namespace Binance.Tests.Cache
{
    public class TradeCacheTest
    {
        ...
        public void LinkToClient()
        {
            ...
            ClassicAssert.Equal(TradeClient.GetStreamName(symbol1), clientSubscribeStreams.Single());
            ...
            ClassicAssert.Equal(TradeClient.GetStreamName(symbol2), cache.SubscribedStreams.Single());
            ...
            ClassicAssert.Contains(TradeClient.GetStreamName(symbol2), client2.SubscribedStreams);
        }
    }
}
