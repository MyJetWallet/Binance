...
namespace Binance.Tests.Cache
{
    public class AggregateTradeCacheTest
    {
        ...
        public void LinkToClient()
        {
            ...
            ClassicAssert.Equal(AggregateTradeClient.GetStreamName(symbol1), clientSubscribeStreams.Single());
            ...
            ClassicAssert.Equal(AggregateTradeClient.GetStreamName(symbol2), cache.SubscribedStreams.Single());
            ...
            ClassicAssert.Contains(AggregateTradeClient.GetStreamName(symbol2), client2.SubscribedStreams);
        }
    }
}
